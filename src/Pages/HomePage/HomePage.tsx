			...
			<div className="bg-sixth py-8">
				<div className="container mx-auto flex flex-wrap ">
					...
					<div className="flex-1">
						<PlantImage className="mx-auto m-8 mb-16" style={{ width: 400, height: 400}}/>
					</div>
				</div>

			</div>
			<div className="bg-fourth py-20 flex flex-wrap justify-center text-gray-800">
