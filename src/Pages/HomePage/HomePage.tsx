			...
			<div className="bg-sixth py-32">
				<div className="container mx-auto flex flex-wrap ">
					...
					<div className="flex-1 mt-8 sm:mt-0">
						<PlantImage className="mx-auto m-8 mb-16 w-[300px] h-[300px]"/>
					</div>
				</div>

			</div>
			<div className="bg-fourth py-32 flex flex-wrap justify-center text-gray-800">
				<InfoBox className="m-4 w-full sm:w-auto">
					<InternetOfThingsImage className="mx-auto m-2 w-[200px] h-[200px]"/>
					<h5 className="text-xl">Connect to your things from anywhere</h5>
				</InfoBox>
				<InfoBox className="m-4 w-full sm:w-auto">
					<TelegramImage className="mx-auto m-2 w-[200px] h-[200px]"/>
					<h5 className="text-xl">Receive notifications on Telegram when events related to your things occurs</h5>
				</InfoBox>
				<InfoBox className="m-4 w-full sm:w-auto">
					<WateringImage className="mx-auto m-2 w-[200px] h-[200px]"/>
